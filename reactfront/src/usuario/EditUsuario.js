    ...
    <div>
      ...
      <form onSubmit={update}>
        ...
        <div className="row align-items-end">
          <div className="form-group col-md-6">
            ...
            >
              ...
              {roles.map((rol) => (
                <option key={rol.id} value={rol.id} selected={rol.id == Rol}>
                  {" "}
                  {rol.Nombre}{" "}
                </option>
              ))}
          ...
          <div className="form-group col-md-6">
            ...
            >
              ...
              {estatusArry.map((estatusItem) => (
                <option
                  key={estatusItem.id}
                  value={estatusItem.id}
                  selected={estatusItem.id == Estatus}
                >
                  {" "}
                  {estatusItem.Nombre}{" "}
                </option>
        ...
        <div className="row align-items-end">
          <div className="form-group col-md-6">
            ...
            >
              ...
              {estados.map((edo) => (
                <option key={edo.id} value={edo.id} selected={edo.id == Estado}>
                  {edo.Estado}
                </option>
              ))}
            </select>
        ...
        <button type="submit" className="btn btn-primary">
          {" "}
          <i className="fa-solid fa-floppy-disk"></i> Actualizar Usuaria{" "}
        </button>
        <Link to={`/usuarios/`} className="btn btn-danger m-2">
          {" "}
