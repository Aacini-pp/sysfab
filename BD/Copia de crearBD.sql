...
-- -----------------------------------------------------
-- Table `fab2`.`Emergencia`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `fab2`.`Emergencia` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `VIctima` INT UNSIGNED NOT NULL,
  `Estatus` INT UNSIGNED NOT NULL DEFAULT 2,
  `Voluntaria_Atendio` INT UNSIGNED NULL,
  `Ubicacion` VARCHAR(45) NULL,
  `createdAt` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updatedAt` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC)  ,
  INDEX `fk_Emergencia_Usuaria1_idx` (`VIctima` ASC)  ,
  INDEX `fk_Emergencia_CatEstatus1_idx` (`Estatus` ASC)  ,
  INDEX `fk_Emergencia_Usuaria2_idx` (`Voluntaria_Atendio` ASC)  ,
  CONSTRAINT `fk_Emergencia_Usuaria1`
    FOREIGN KEY (`VIctima`)
    REFERENCES `fab2`.`Usuaria` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_Emergencia_CatEstatus1`
    FOREIGN KEY (`Estatus`)
    REFERENCES `fab2`.`CatEstatus` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Emergencia_Usuaria2`
    FOREIGN KEY (`Voluntaria_Atendio`)
    REFERENCES `fab2`.`Usuaria` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `fab2`.`CatTokens`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `fab2`.`CatTokens` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
...
-- Table `fab2`.`Tokens`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `fab2`.`Tokens` (
  `token` VARCHAR(45) NOT NULL,
  `Usuaria` INT UNSIGNED NOT NULL DEFAULT 1,
  `Estatus` INT UNSIGNED NOT NULL DEFAULT 1,
  ...
  `createdAt` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updatedAt` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  INDEX `fk_tokens_Usuaria1_idx` (`Usuaria` ASC)  ,
  UNIQUE INDEX `tokens_index_UNIQUE` (`token` ASC)  ,
  PRIMARY KEY (`token`),
  INDEX `fk_tokens_CatEstatus1_idx` (`Estatus` ASC)  ,
  INDEX `fk_Tokens_CatTokens1_idx` (`Tipo` ASC)  ,
  CONSTRAINT `fk_Rtokens_Usuaria1`
    FOREIGN KEY (`Usuaria`)
    REFERENCES `fab2`.`Usuaria` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_tokens_CatEstatus1`
    FOREIGN KEY (`Estatus`)
    REFERENCES `fab2`.`CatEstatus` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Tokens_CatTokens1`
    FOREIGN KEY (`Tipo`)
    REFERENCES `fab2`.`CatTokens` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
